...
void DspABIDO(void);
  ...
  PARAM  Param[8] = {  //X0,Y0,PV,SV,CF,ALARM
	    {3,35,&temperature[0].PV10,&temperature[0].SV10,&temperature[0].cf,&temperature[0].alarm},  
        {182,35,&temperature[1].PV10,&temperature[1].SV10,&temperature[1].cf,&temperature[1].alarm},  
        {361,35,&temperature[2].PV10,&temperature[2].SV10,&temperature[2].cf,&temperature[2].alarm},  
        {540,35,&temperature[3].PV10,&temperature[3].SV10,&temperature[3].cf,&temperature[3].alarm},
	    {3,258,&temperature[4].PV10,&temperature[4].SV10,&temperature[4].cf,&temperature[4].alarm},
        {182,258,&temperature[5].PV10,&temperature[5].SV10,&temperature[5].cf,&temperature[5].alarm},
        {361,258,&temperature[6].PV10,&temperature[6].SV10,&temperature[6].cf,&temperature[6].alarm},
        {540,258,&temperature[7].PV10,&temperature[7].SV10,&temperature[7].cf,&temperature[7].alarm},
  };
...
void _DrawPanel(void * p)
{
	...
	GUI_GotoXY(pParam->x0+53, pParam->y0+115);	
