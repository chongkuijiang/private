...
#define macGPIO_PORT_I2C	GPIOA			/* GPIO端口 */
#define macRCC_I2C_PORT 	RCC_APB2Periph_GPIOA		/* GPIO端口时钟 */
#define macI2C_SCL_PIN		GPIO_Pin_11			/* 连接到SCL时钟线的GPIO */
#define macI2C_SDA_PIN		GPIO_Pin_12			/* 连接到SDA数据线的GPIO */
